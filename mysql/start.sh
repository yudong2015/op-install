...
docker run -it -d -p 3306:3306 --name ${CONTAINER_NAME} -v /opt/db/ddl:/docker-entrypoint-initdb.d -v /opt/db/mysql:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=${MYSQL_ROOT_PASSWORD} mysql:8.0.11
