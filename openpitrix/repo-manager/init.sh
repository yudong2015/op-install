...
# befor migrating, copy app schema from openpitrix/pkg/schema/repo to /opt/repo-manager/schema
docker run -it -d -v /opt/repo-manager/schema:/flyway/sql --net=host \
